...
import { Button, Input, TrashAlert } from "@/components/ui";
  ...
  return (
    <div className="flex items-center justify-between gap-x-3">
      <div className="flex items-center space-x-2 ml-2">
        <TrashAlert onConfirm={handleTrash}>
          <Button
            variant="ghost"
      ...
      <div className="flex flex-1 items-center space-x-2">
        <Input
          placeholder="Search Committee Members by Name, Mobile or Email"
          defaultValue={search}
      ...
      <Button
        size={"sm"}
        onClick={() => {
          router.push("/committee-members/create");
        }}
      >
        Add Committee Member <Plus className="ml-2 h-4 w-4" />
      </Button>
    </div>
  );
}
